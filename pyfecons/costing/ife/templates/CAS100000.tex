...
D-T fusion under NRC Part 30 requires no 10-mile exclusion zone (emergency planning at site boundary only), enabling compact siting comparable to gas turbine plants. The CFS ARC project (100 acres for 400 MWe) provides the best commercial-scale data point, yielding a land intensity of $\sim$0.25 acres/MWe.

US farmland averages \$4,350/acre (USDA 2025). Industrial-zoned sites near grid infrastructure command a 2--5$\times$ premium, giving a working estimate of $\sim$\$10,000/acre for greenfield fusion siting.
