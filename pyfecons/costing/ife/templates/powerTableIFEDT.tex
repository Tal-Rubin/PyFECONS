...
1.4	&	Neutron Energy Multiplier	&	$M_N$	&	MN	&	\\
1.5	&	$P_{pump}$ capture efficiency	&	$\eta_{{pump}}$	&	ETAP	&	\\
1.6	&	Thermal Power	&	$P_{{TH}} = M_N P_n + P_{{ash}} + P_{{IN}} + \eta_p P_{{pump}}$	&	PTH	&	MW \\
...
2.2	&	Coolant Pumping Power	&	$P_{{pump}}$	&	PP	&	MW \\
...
2.5	&	Cryo vacuum pumping	&	$P_{{p}_c}$	&	PCRYO	&	MW \\
