...
% Sensitivity analysis flag - will be replaced by Python based on sensitivity results
\newif\ifsensitivity
%sensitivity_flag%
...
%\pagestyle{fancy}
    ...
    \input{Modified/PhysicsChecks.tex}
...
\ifsensitivity
    \input{Modified/SensitivityAnalysis.tex}
\fi
