...
\begin{itemize}
    ...
    \item Cost Category 22.05.07 Tritium containment barriers. Multiple confinement barriers (seals, membranes, specialized containment systems) required to prevent environmental tritium release through permeation of hot steel structures. Regulatory compliance requirement for D-T and D-D fusion.
    \item Cost Category 22.05.08 Pellet injection system. Cryogenic pellet injectors for plasma fueling and ELM pacing. Includes centrifuge or pneumatic launcher, pellet fabrication, guide tubes, and diagnostics. Scaled from ITER pellet injector with learning curve credit.
\end{itemize}
