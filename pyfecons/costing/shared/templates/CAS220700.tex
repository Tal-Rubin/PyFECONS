...
We use the NETL Case B31A Category 12 Instrumentation and Control for a 727MW Net power plant with bare erected costs of \$14M representing 19\$/kW.  Instrumentation in the heat island remains a major cost driver for FOAK, but by NOAK should come pre-packaged as multiple instrument packages, totalling \$ 50M, giving 88\$/kW.  The reference cost of \$85M at 3000 MW$_{th}$ is scaled with plant thermal power using an economy-of-scale exponent of 0.5.  We calculate \$ C220700 M for this cost category.