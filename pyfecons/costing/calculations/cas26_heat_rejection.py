...
def cas26_heat_rejection_costs(basic: Basic, power_table: PowerTable, constants: CostingConstants) -> CAS26:
    ...
    cas26.C260000 = M_USD(
        float(basic.n_mod) * power_table.p_et * constants.heat_rejection_per_mw * inflation_factor_2019_2024
    )
    return cas26
